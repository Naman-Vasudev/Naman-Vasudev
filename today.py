...
if __name__ == '__main__':
    ...
    # IMPORTANT: CHANGE THIS TO YOUR BIRTHDATE!
    # Format: datetime.datetime(YEAR, MONTH, DAY)
    # Example: datetime.datetime(2003, 6, 15) for June 15, 2003
    age_data, age_time = perf_counter(daily_readme, datetime.datetime(2006, 10, 24))
